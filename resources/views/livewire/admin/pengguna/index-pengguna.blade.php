    ...
    <div class="mx-auto">
        ...
        @endif
            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                <div class="w-full md:w-1/2">
                    <h2 class="text-4xl font-extrabold">Data Pengguna</h2>
                </div>
                <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <div class="flex items-center">
                            ...
                            <a class="text-sm font-medium text-gray-700 ms-1">Pengguna</a>
                        </div>
                        </li>
                    </ol>
                    </nav>
        ...
        <div class="relative overflow-hidden bg-white shadow-md sm:rounded-lg">
            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                ...
                <!-- Button -->
                <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                    <a href="{{ route('admin.pengguna.create') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none">
                        Tambah Pengguna
                    </a>
                </div>
            </div>
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3">No Telepon/WA</th>
                        ...
                        @forelse($users as $user)
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 capitalize">
                                    @if($user['roles'] == 'admin')
                                        <span class="bg-purple-100 text-purple-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-sm">{{ $user['roles'] }}</span>
                                    @elseif($user['roles'] == 'petugas')
                                        <span class="bg-yellow-100 text-yellow-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-sm">{{ $user['roles'] }}</span>
                                    @elseif($user['roles'] == 'warga')
                                        <span class="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-sm">{{ $user['roles'] }}</span>
                                    @else
                                        <span class="bg-gray-100 text-gray-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-sm">{{ $user['roles'] }}</span>
                                    @endif
                                </td>
                                    ...
                                    <div x-data="{ openDropdown: false, openModal: false }" class="relative">
                                        ...
                                        >
                                            <ul class="py-1 text-sm text-gray-700">
                                                <li>
                                                    <a href="{{ route('admin.pengguna.edit', $user['id']) }}" class="block px-4 py-2 hover:bg-gray-100">Ubah</a>
                                                </li>
                                                <li>
                                        ...
                                        <div x-show="openModal"
                                            ...
                                            <div class="relative w-full max-w-md p-4 bg-white rounded-lg shadow-xl">
                                                ...
                                                <div class="p-4 text-center md:p-5">
                                                    ...
                                                    <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah kamu yakin ingin menghapus pengguna ini?</h3>
