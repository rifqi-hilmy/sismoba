...
class DetailMonitoring extends Component
{
    ...
    public $sensorData = [];
    public $activeTab = 'styled-profile';
    ...
    public function setActiveTab($tab)
    {
        ...
        // Jika tab grafik dipilih, render grafik setelah sedikit delay
        if ($tab === 'styled-contacts') {
            $this->dispatch('renderCharts', sensorData: $this->sensorData);
        }
    }
    ...
    public function fetchSensorData()
    {
        try {
            ...
            if ($response->successful()) {
                ...
                $this->dispatch('sensorDataUpdated', sensorData: $this->sensorData);
            }
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.admin.monitoring.detail-monitoring');
    }
